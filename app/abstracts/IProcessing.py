...
class ProcessingInterface(ABC):
    ...
    @abstractmethod
    def detected_objects_in_background(self, img_undistorted, confianza_minima=0.2, callback=None,relation_x=0.00000,relation_y=0.00000,roi=None,x_center=None,y_center=None):
        pass
    @abstractmethod
